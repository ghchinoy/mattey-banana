 ...
 * @returns {string}
 */
export function export_to_fletcher_dxf(paths_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(paths_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.export_to_fletcher_dxf(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_getRandomValues_9c5c1b115e142bb8 = function() { return handleError(function (arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('matte_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
